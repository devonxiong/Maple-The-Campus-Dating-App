...
export default function MatchPage() {
  ...
  if (screen === 'confirmed') {
    ...
    const whatsappUrl = them?.phone
      ? `https://wa.me/${them.phone.replace(/\D/g, '')}`
      : null
            ...
            <div className="space-y-2">
              ...
              {whatsappUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-center gap-2 bg-[#25D366] text-white rounded-xl py-3 text-xs font-medium active:scale-[0.98] transition-transform"
                >
