...
export const FEED = {
  en: {
    ...
    whileYouWait: 'in the meantime',
    waitTip1: 'Pull your friends in. The more of campus is on here, the more paths you actually cross.',
    waitTip2: 'Anyone you passed comes back around after 30 days, so you get a second look.',
  ...
  zh: {
    ...
    whileYouWait: '这段时间',
    waitTip1: '把朋友拉进来。校园里的人越多，你真正擦肩而过的人也越多。',
    waitTip2: '划过的人 30 天后会重新出现，你还能再看一眼。',
    seeAgain: '再看一遍',
